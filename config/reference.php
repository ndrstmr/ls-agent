 ...
 *     },
 * }
 * @psalm-type StegConfig = array{
 *     connections?: array<string, array{ // Default: []
 *             dsn?: scalar|Param|null, // DSN string, e.g. vllm://gpu-server:8000/v1?model=llama-3.3-70b-awq // Default: null
 *             base_url?: scalar|Param|null, // Base URL for the inference server (alternative to DSN) // Default: null
 *             model?: scalar|Param|null, // Model name (required when using base_url instead of DSN) // Default: null
 *             api_key?: scalar|Param|null, // API key (optional, defaults to EMPTY for local servers) // Default: "EMPTY"
 *             timeout?: int|Param, // Request timeout in seconds (must be > 0) // Default: 120
 *         }>,
 *     default_connection?: scalar|Param|null, // Name of the default connection (defaults to first defined connection) // Default: null
 * }
